...
namespace BM
{
    public static partial class AssetComponent
    {
        ...
        public static async ETTask<bool> Initialize(string bundlePackageName, string secretKey = null)
        {
            ...
            string filePath = BundleFileExistPath(bundlePackageName, "FileLogs.bytes", true);
            ...
            string dependPath = BundleFileExistPath(bundlePackageName, "DependLogs.bytes", true);
            ...
            string groupPath = BundleFileExistPath(bundlePackageName, "GroupLogs.bytes", true);
