...
namespace WorkTools
{
    ...
    {
        public DependenceData.AssetDescription data;
    }

    //资源引用树
    public class DependenceTreeView : TreeView
    {
        //图标宽度
        ...
        public DependenceTreeView(TreeViewState state, MultiColumnHeader multicolumnHeader) : base(state, multicolumnHeader)
        {
        ...
        public static MultiColumnHeaderState CreateDefaultMultiColumnHeaderState(float treeViewWidth)
        {
            ...
            {
                headerContent = new GUIContent("资产名称"),
            ...
            new MultiColumnHeaderState.Column
            {
                headerContent = new GUIContent("资产路径"),
                headerTextAlignment = TextAlignment.Center,
                sortedAscending = false,
                width = 360,
                minWidth = 60,
            ...
            new MultiColumnHeaderState.Column
            {
                headerContent = new GUIContent("资源状态"),
                headerTextAlignment = TextAlignment.Center,
                sortedAscending = false,
                width = 60,
                minWidth = 60,
        ...
        void CellGUI(Rect cellRect, AssetViewItem item, MyColumns column, ref RowGUIArgs args)
        {
            ...
            switch (column)
            {
                ...
                case MyColumns.State:
                    {
                        GUI.Label(cellRect, DependenceData.GetInfoByState(item.data.state), stateGUIStyle);
                    }
                    break;
            }
        }
